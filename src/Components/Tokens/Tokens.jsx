  ...
  return (
    <div className=' min-h-screen flex flex-col gap-4 bg-kickto-dark bg-cover bg-shard-back py-12 gap-y-6'>
      <div className='  text-center'>
        <h2 className='   p-6  mx-auto text-6xl uppercase font-extrabold italic tracking-widest drop-shadow text-white'>
          Tokens
        </h2>
      </div>
      ...
      <div className='  grid sm:grid-cols-2 gap-4'>
        ...
        <div className='flex flex-col items-center align-middle  gap-4 mt-24 sm:mt-0'>
          ...
          <div className=' font-semibold chiplet  text-white text-2xl -skew-x-12 hover:skew-x-0 transition-all duration-200 hover:shadow-md bg-gradient-to-r from-[#FF8B3E] to-[#C41716] '>
            Health Token
          </div>
          <div className='relative hover:scale-105 transform duration-300 cursor-pointer'>
            <img
